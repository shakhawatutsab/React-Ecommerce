  ...
  return (
    <>
      ...
      <div className="header-desk header-desk_type_5">
        ...
        <form
          action="https://uomo-html.flexkitux.com/Demo9/"
          method="GET"
          ...
          <ul className="navigation__list list-unstyled d-flex">
                  ...
                  <div className="mega-menu__media col">
                    <div className="position-relative">
                      <img
                        ...
                        src="https://uomo-html.flexkitux.com/images/mega-menu-item.jpg"
                        alt="New Horizons"
                      />
                      <div
                        className="mega-menu__media-content content_abs content_left content_bottom"
                      >
                        <h3>NEW</h3>
            ...
            <li className="navigation__item">
              ...
              <ul className="default-menu list-unstyled">
                ...
                <li className="sub-menu__item">
                  <a href="blog_single.html" className="menu-link menu-link_us-s"
                    >Blog Detail</a
                  >
                </li>
              </ul>
            ...
            <li className="navigation__item">
              ...
              <ul className="default-menu list-unstyled">
                ...
                <li className="sub-menu__item">
                  <a href="faq.html" className="menu-link menu-link_us-s">Faq</a>
                </li>
                <li className="sub-menu__item">
                ...
                <li className="sub-menu__item">
                  <a href="coming_soon.html" className="menu-link menu-link_us-s"
                    >Coming Soon</a
                  >
                </li>
              </ul>
        ...
        <div className="header-tools d-flex align-items-center">
          <div className="header-tools__item hover-container d-block d-xxl-none">
            ...
            <div className="search-popup js-hidden-content">
              <form
                action="https://uomo-html.flexkitux.com/Demo9/search_result.html"
                method="GET"
